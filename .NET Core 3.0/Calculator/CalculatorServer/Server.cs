...
using CalculatorServer.Utils.Messages;
using NLog;
using System;
...
namespace CalculatorServer
{
    internal sealed class Server : IDisposable
    {
        ...
        public Server(ServerData serverData) : this(host: serverData.Host, port: serverData.Port)
        {
        ...
        public IEnumerable<Grpc.Core.ServerServiceDefinition> Services
        {
            get
            {
                yield return Generated.CalculatorService.BindService(new Services.CalculatorService());
            }
        }
